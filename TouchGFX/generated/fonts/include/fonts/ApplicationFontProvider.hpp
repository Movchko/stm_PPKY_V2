...
{
    static const touchgfx::FontId DEFAULT = 0; // MonospaceRegular_20_1bpp
    static const touchgfx::FontId LARGE = 0;   // MonospaceRegular_20_1bpp
    static const touchgfx::FontId SMALL = 1;   // MonospaceRegular_15_1bpp
